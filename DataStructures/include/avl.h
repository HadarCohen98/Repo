...
/*----------------------------------------------------------------------------*/
/*
    Params: avl_t type pointer to the tree.
    Return: height of tree in size_t type.
    Complexity: O(log n) where h is height of tree.
*/
...
/*
	...
	was sent.
	Return: The node that holds data_to_match when found, else NULL.
	Complexity: O(log(n)).
*/
